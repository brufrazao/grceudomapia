...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-blue-100 via-slate-100 to-yellow-50 py-20">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <img 
                ...
                className="rounded-lg shadow-2xl w-full border-4 border-slate-200"
              />
            </div>
          </div>
        </div>
